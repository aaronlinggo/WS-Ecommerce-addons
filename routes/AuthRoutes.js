...
router.get('/verifyDeveloper/:developerId/:token', AuthController.verifyEmailDeveloper);
router.get('/verifyCustomer/:customerId/:token', AuthController.verifyEmailCustomer);
